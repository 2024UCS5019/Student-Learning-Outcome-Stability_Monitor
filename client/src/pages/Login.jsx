    ...
    <div className="app-bg min-h-screen flex items-center justify-center px-4">
      <div className="card-panel p-8 w-full max-w-md">
        ...
        <button
          ...
          className="w-full py-2 px-4 border border-gray-300 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition"
        >
        ...
        <p className="muted text-sm mt-4">
          New here? <Link to="/register" className="text-sky-600">Create account</Link>
        </p>
      </div>
    </div>
  );
